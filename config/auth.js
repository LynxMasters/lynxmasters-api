...
module.exports = {
     ...
     'reddit' : {
        ...
        'callbackURL'      : 'http://lynxmasters.com/auth/reddit/callback',
    ...
    'twitch' : {
        ...
        'callbackURL'     : 'http://lynxmasters.com/auth/twitch/callback',
    ...
    'twitter' : {
        ...
        'callbackURL'        : 'http://lynxmasters.com/auth/twitter/callback'
